...
for (const d of reversedData) {
  ...
  console.log(`${d.date} marker coordinates after ${d.combinedKm}km, to ${accumulatedDistFromStats}km = ${accumulatedDistFromStats * 5/8}m : ${point.geometry.coordinates[1]}, ${point.geometry.coordinates[0]}`);
};
